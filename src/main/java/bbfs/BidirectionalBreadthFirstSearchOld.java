// BidirectionalBreadthFirstSearchOld
package bbfs;
 ...
 */
public class BidirectionalBreadthFirstSearchOld<V extends Vertex, E extends DirectedEdge<V>> extends Algorithm<Vertex, DirectedEdge<Vertex>> {
    ...
    public BidirectionalBreadthFirstSearchOld(BasicDirectedGraph<V, E> graph, boolean isParallel) {
        this.graph = graph;
